...
import { getAllTeachers,type TeacherData } from "../../services/users.service";
...
export default function TeachersPage() {
  ...
  useEffect(() => {
    ...
    getAllTeachers(collegeName, deptFilter).then((data) => {
      setTeachers(data);
      setLoading(false);
    });
  }, [department]); // Refresh when department changes
